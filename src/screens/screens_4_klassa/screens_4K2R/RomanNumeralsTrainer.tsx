    ...
    const generateProblem = () => {
        ...
        while (true) {
            ...
            if (type < 0.5) { // ROMAN -> ARABIC
                ...
                hint = specials.length > 0 ? `Pamiętaj o parach: ${specials.join(', ')}.` : `Wartości: I(1), V(5), X(10), L(50), C(100), D(500), M(1000).`;
                if (Math.random() < 0.4) {
                ...
                sub = `${val} = ...`;
                hint = "I(1), V(5), X(10), L(50), C(100), D(500), M(1000)\nOdejmowanie: IV(4), IX(9), XL(40), XC(90), CD(400), CM(900)";
                if (Math.random() < 0.4) {
                                ...
                                <View style={{ width: '100%', alignItems: 'center' }}>
                                    <TextInput
                                        style={[
                                            ...
                                            isInputWrong && { backgroundColor: theme.errorBg, borderColor: '#dc3545' }
                                        ]}
                                        ...
                                        placeholder="?"
                                        placeholderTextColor={isDarkMode ? '#94A3B8' : '#aaa'}
                                    />
                                </View>
                            )}
...
const styles = StyleSheet.create({
    ...
    questionMain: { fontSize: 18, fontWeight: 'bold', textAlign: 'center', marginBottom: 10 },
    ...
    finalInput: { width: '80%', height: 60, borderWidth: 2, borderRadius: 15, textAlign: 'center', fontSize: 26, marginTop: 10, fontWeight: 'bold' },
