...
const combinedIconSize = screenWidth * 0.25; // POWRÓT DO TWOJEGO ROZMIARU
...
const FractionsAdditionTrainer = () => {
    ...
    const generateProblem = () => {
        ...
        do {
            ...
            newTask = {
                q: 'Oblicz sumę.', h: 'Dodaj całości i liczniki. Jeśli licznik ≥ mianownik, wyłącz całości.',
                    ...
                    <Modal visible={isFinished} transparent={true} animationType="fade">
                        <View style={styles.modalOverlay}>
                            <View style={styles.milestoneCard}>
                                ...
                                <View style={styles.statsRowMilestone}><Text style={styles.statsTextMilestone}>Wynik końcowy: {stats.correct} / {TASKS_LIMIT}</Text></View>
                                        ...
                                        <>
                                            ...
                                            <View style={styles.mixedInputContainer}>
                                                {(task.hasFinalWhole || task.finalNum === 0) && (
                                                    <TextInput ref={finalWholeRef} style={[styles.wholeInput, getInputStyle(inpFinalWhole, task.finalWhole)]} keyboardType="numeric" value={inpFinalWhole} onChangeText={t => {setInpFinalWhole(t); setStatus('neutral');}} onSubmitEditing={() => finalNumRef.current?.focus()} blurOnSubmit={false} editable={!ready} placeholder="?" />
                                                )}
                                                {task.finalNum > 0 && (
                                                    <View style={styles.fractionInputColumn}>
