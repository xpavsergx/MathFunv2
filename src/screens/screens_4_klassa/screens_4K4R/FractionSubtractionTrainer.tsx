                            ...
                            <View style={styles.taskContent}>
                                <View style={styles.equationRow}>
                                    ...
                                    <View style={styles.mixedInputContainer}>
                                        {task.hasMidWhole && (
                                            <TextInput ref={midWholeRef} style={[styles.wholeInput, getInputStyle(inpMidWhole, task.midWhole)]} keyboardType="numeric" value={inpMidWhole} onChangeText={t => {setInpMidWhole(t); setStatus('neutral');}} onSubmitEditing={() => midNumRef.current?.focus()} blurOnSubmit={false} editable={!ready} placeholder="?" />
                                        )}
                                        <View style={styles.fractionInputColumn}>
                                            <TextInput ref={midNumRef} style={[styles.fractionInput, getInputStyle(inpMidNum, task.midNum)]} keyboardType="numeric" value={inpMidNum} onChangeText={t => {setInpMidNum(t); setStatus('neutral');}} onSubmitEditing={() => midDenRef.current?.focus()} blurOnSubmit={false} editable={!ready} placeholder="?" />
                                            <View style={styles.fractionLineLarge} />
                                            <TextInput ref={midDenRef} style={[styles.fractionInput, getInputStyle(inpMidDen, task.midDen)]} keyboardType="numeric" value={inpMidDen} onChangeText={t => {setInpMidDen(t); setStatus('neutral');}} onSubmitEditing={() => task.isTwoStep ? (task.hasFinalWhole ? finalWholeRef.current?.focus() : finalNumRef.current?.focus()) : handleCheck()} blurOnSubmit={!task.isTwoStep} editable={!ready} placeholder="?" />
                                        </View>
                                    </View>
                                        ...
                                        <>
                                            ...
                                            <View style={styles.mixedInputContainer}>
                                                {(task.hasFinalWhole || task.finalNum === 0) && (
                                                    <TextInput ref={finalWholeRef} style={[styles.wholeInput, getInputStyle(inpFinalWhole, task.finalWhole)]} keyboardType="numeric" value={inpFinalWhole} onChangeText={t => {setInpFinalWhole(t); setStatus('neutral');}} onSubmitEditing={() => task.finalNum > 0 && finalNumRef.current?.focus()} blurOnSubmit={false} editable={!ready} placeholder="?" />
                                                )}
                                                {task.finalNum > 0 && (
                                                    <View style={styles.fractionInputColumn}>
                                                        <TextInput ref={finalNumRef} style={[styles.fractionInput, getInputStyle(inpFinalNum, task.finalNum)]} keyboardType="numeric" value={inpFinalNum} onChangeText={t => {setInpFinalNum(t); setStatus('neutral');}} onSubmitEditing={() => finalDenRef.current?.focus()} blurOnSubmit={false} editable={!ready} placeholder="?" />
                                                        <View style={styles.fractionLineLarge} />
                                                        <TextInput ref={finalDenRef} style={[styles.fractionInput, getInputStyle(inpFinalDen, task.finalDen)]} keyboardType="numeric" value={inpFinalDen} onChangeText={t => {setInpFinalDen(t); setStatus('neutral');}} onSubmitEditing={handleCheck} editable={!ready} placeholder="?" />
                                                    </View>
                                                )}
                                            </View>
                                        </>
...
const styles = StyleSheet.create({
    ...
    headerTitle: { fontSize: 22, fontWeight: '800', color: '#007AFF', marginBottom: 20, textTransform: 'uppercase' },
    ...
    staticWhole: { fontSize: 28, fontWeight: 'bold', color: '#2c3e50', marginRight: 4 },
    fractionStatic: { alignItems: 'center' },
    staticNum: { fontSize: 24, fontWeight: 'bold', color: '#2c3e50' },
    staticLine: { width: 35, height: 3, backgroundColor: '#2c3e50', marginVertical: 3 },
    staticDen: { fontSize: 24, fontWeight: 'bold', color: '#2c3e50' },
    ...
    fractionLineLarge: { width: 70, height: 3, backgroundColor: '#333', marginVertical: 4 },
    ...
    mButton: { paddingVertical: 12, borderRadius: 12, width: '100%', alignItems: 'center', backgroundColor: '#28a745' },
