                                ...
                                <View style={[styles.diagramArea, { backgroundColor: theme.diagramBg }]}>
                                    ...
                                    {step >= 2 && (
                                        <Text style={[styles.diagramText, { color: theme.textMain }]}>
                                            1 tona (t) = {highlightElements("1000")} kilogramów (kg)
                                        </Text>
                                    )}
                                    {step >= 3 && (
                                        <Text style={[styles.diagramText, { color: theme.textMain }]}>
                                            1 kilogram (kg) = {highlightElements("100")} dekagramów (dag) = {highlightElements("1000")} gramów (g)
                                        </Text>
                                    )}
                                    {step >= 4 && (
                                        <Text style={[styles.diagramText, { color: theme.textMain }]}>
                                            1 dekagram (dag) = {highlightElements("10")} gramów (g)
                                        </Text>
                                    )}
                                </View>
                            )}
