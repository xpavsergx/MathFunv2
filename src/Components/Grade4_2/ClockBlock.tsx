...
export default function ClockBlock() {
    ...
    const theme = {
        ...
        digitalBg: isDarkMode ? '#000000' : '#424242',
    };
                                ...
                                <View style={[styles.diagramArea, { backgroundColor: theme.diagramBg }]}>
                                    ...
                                    {step >= 2 && (
                                        <View style={styles.clockVisual}>
                                            ...
                                            <Text style={[styles.diagramText, { color: theme.textMain }]}>
                                                Wskazuje minuty. Pamiętaj: każda duża kreska to {highlightElements("5")} minut.
                                            </Text>
                                        </View>
                                    )}
                                    ...
                                    {step >= 4 && (
                                        <View style={styles.clockDigitalContainer}>
                                            ...
                                            <View style={[styles.clockDigital, { backgroundColor: theme.digitalBg }]}>
                                                <Text style={styles.clockDigitalText}>14:30</Text>
                                            </View>
                                            <Text style={[styles.diagramText, { color: theme.textMain }]}>
                                                Format {highlightElements("24")} godzinny jest najdokładniejszy.
                                            </Text>
                                        </View>
                                    )}
                                </View>
...
const styles = StyleSheet.create({
    ...
    finalBlock: { alignItems: 'center', width: '100%', marginTop: 10, paddingTop: 10, borderTopWidth: 1 },
