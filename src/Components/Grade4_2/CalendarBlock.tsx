                                ...
                                <View style={[styles.diagramArea, { backgroundColor: theme.diagramBg }]}>
                                    ...
                                    {step >= 2 && (
                                        <Text style={[styles.diagramText, { color: theme.textMain }]}>
                                            1 rok to {highlightElements("12")} miesięcy.
                                        </Text>
                                    )}
                                    {step >= 3 && (
                                        <Text style={[styles.diagramText, { color: theme.textMain }]}>
                                            Miesiąc to {highlightElements("30")} lub {highlightElements("31")} dni.
                                        </Text>
                                    )}
                                    {step >= 4 && (
                                        <Text style={[styles.diagramText, { color: theme.textMain }]}>
                                            Tydzień to {highlightElements("7")} dni.
                                        </Text>
                                    )}
                                </View>
                            )}
