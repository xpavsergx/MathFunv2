...
export default function DynamicAdditionBlock() {
    ...
    const getExplanationText = (visStep: number, num1: string, num2: string) => {
        ...
        if (isHighlight(1)) {
            ...
            return `Wynik (12): Zapisz 2 i PRZENIEŚ 1 na górę kolumny Dziesiątek.`;
        } else if (isHighlight(5)) {
            return `Krok 2: Podświetlamy DZIESIĄTKI. Dodajemy: 1 (przeniesienie) + ${num1[0]} + ${num2[0]}.`;
        } else if (isHighlight(6)) {
            return `Wynik (7): Zapisujemy 7. Zadanie wykonane!`;
        } else {
            // Stan początkowy (step = 0)
            ...
            <View style={styles.overlay}>
                <View style={styles.container}>
                    ...
                    >
                        ...
                        {/* Wersja minimalistyczna nie powinna ukrywać diagramu w step=0, bo tam jest tekst! */}
